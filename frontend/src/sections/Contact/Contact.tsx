...
export function Contact() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Pure frontend — open mailto with pre-filled subject and body.
    // No backend required; works on Vercel as a static deployment.
    setStatus('loading')
    try {
  ...
  return (
    <section id="contact" className="section-wrapper relative overflow-hidden" aria-label="Contact">
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'rgba(10,15,30,0.30)' }} aria-hidden="true" />
      <div className="glow-blob w-96 h-96 opacity-[0.07]" style={{
        top: '-4rem', left: '50%', transform: 'translateX(-50%)',
        background: 'radial-gradient(circle, rgba(0,229,255,0.5) 0%, transparent 70%)',
      }} aria-hidden="true" />

      <Container className="relative z-10">
        <SectionTitle title="Establish Connection" subtitle={contact.subheading} />

        <div style={{ display: 'grid', gridTemplateColumns: '2fr 3fr', gap: '2rem', maxWidth: '960px', margin: '0 auto' }}
          ...
          >
            ...
            <Card padding="md">
              <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', lineHeight: 1.75 }}>
                Whether you have a project idea, an internship opportunity, or simply want to connect —
                feel free to reach out. I respond within 24–48 hours.
              </p>
            </Card>
          </motion.div>
              ...
              {status === 'error' && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                  ...
                  <button onClick={reset} style={{
                    marginLeft: 'auto', color: 'rgba(239,68,68,0.6)',
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}
                    ...
                    <div>
                      ...
                      <input id="name" name="name" type="text" value={formData.name}
                        onChange={handleChange} onBlur={handleBlur} placeholder="Your full name" autoComplete="name"
                    ...
                    <div>
                      ...
                      <input id="email" name="email" type="email" value={formData.email}
                        onChange={handleChange} onBlur={handleBlur} placeholder="your@email.com" autoComplete="email"
                    ...
                    <div style={{ gridColumn: '1 / -1' }}>
                      ...
                      <input id="subject" name="subject" type="text" value={formData.subject}
                        onChange={handleChange} onBlur={handleBlur} placeholder="What's this about?" autoComplete="off"
