...
export function Skills() {
  ...
  return (
    <section id="skills" className="section-wrapper section-divided" aria-label="Skills">
      <Container>
        <SectionTitle
          title="Technical Expertise"
          subtitle="Tools and disciplines I work with, grouped by category."
        />
              ...
              <Card padding="md" className="h-full" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}
                  ...
                  {cat.skills.map(skill => (
                    <span key={skill} role="listitem" className="skill-badge">
                      {skill}
                    </span>
                  ))}
                </div>
