        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <p style={{ fontSize: '1rem', color: 'var(--text-secondary)', lineHeight: 1.75 }}>
              Background, certifications, and core competencies — available for download.
            </p>
          </motion.div>

          <SectionTitle title="Resume" subtitle="Background, certifications, and core competencies." className="sr-only" />
          ...
          <div className="grid md:grid-cols-2 gap-5">
              ...
              <Card padding="md" className="h-full">
                ...
                {resume.education.map((edu, i) => (
                  <div key={i} style={{
                    ...
                    paddingBottom: i < resume.education.length - 1 ? '1.25rem' : 0,
                    ...
                    <p style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-primary)' }}>{edu.institution}</p>
                    <p style={{ fontSize: '0.85rem', color: 'var(--accent)', marginTop: '2px' }}>{edu.degree}</p>
                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: '2px' }}>{edu.period}</p>
                    {edu.details && (
                      <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: '4px', fontStyle: 'italic' }}>{edu.details}</p>
                    )}
                  </div>
                ))}
              </Card>
            ...
            <motion.div {...fadeUp(0.24)}>
              <Card padding="md" className="h-full">
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }} role="list" aria-label="Core competencies">
          ...
          >
            <p style={{
              fontFamily: "'Space Grotesk', system-ui, sans-serif",
              fontSize: '1rem', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '0.5rem',
            }}>
